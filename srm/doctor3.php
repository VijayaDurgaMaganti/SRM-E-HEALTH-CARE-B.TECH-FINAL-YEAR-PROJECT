        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          ...
          <ul class="nav justify-content-end">
            ...
            <li class="nav-item active">
              <button type="button" class="btn btn-outline-primary"><a class="nav-link" href="drview3.php">Consulted</a></button>
            </li>&nbsp;
            <li class="nav-item active">
...
<?php
            include("connection.php");
            error_reporting(0);
            $query = "SELECT * FROM appointments WHERE doctor = 'Dr. A Lakshman - Cardiologist' GROUP BY date ASC ";
