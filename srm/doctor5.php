        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          ...
          <ul class="nav justify-content-end">
            ...
            <li class="nav-item active">
              <button type="button" class="btn btn-outline-primary"><a class="nav-link" href="drview5.php">Consulted</a></button>
            </li>&nbsp;
            <li class="nav-item active">
...
<?php
            include("connection.php");
            error_reporting(0);
            $query = "SELECT * FROM appointments WHERE doctor = 'Dr. Gopal Krishna - Psychiatrist'GROUP BY date ASC ";
