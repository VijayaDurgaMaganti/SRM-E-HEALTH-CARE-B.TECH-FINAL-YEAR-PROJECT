...
<html lang="en">
   ...
   <body class="clinic_version">
      ...
      <header>
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                       ...
                       ?></a></li>
                        ...
                        <li><a data-scroll href="#service">Contact</a></li>
                        <li><a class="active" href="emergency.html">Emergency</a>
         ...
         <marquee direction="left" bgcolor="white" scrolldelay="10s"><h1>🚑The Ambulence is on its way to your landmark🚨🚨🚨</h1></marquee>
      </header>


      <div id="home" class="parallax first-section wow fadeIn" data-stellar-background-ratio="0.4" style="background-image:url('images/slider-p3.png');">
         <div class="container">
            <div class="row">
                     ...
                     <div class="subcriber-box">
                        <form id="mc-form" class="mc-form" action="subscribe.php" method="post">
                           <div class="newsletter-form">
                              <input type="email" autocomplete="off" id="mc-email" placeholder="Email address" class="form-control" name="Email_ID">
