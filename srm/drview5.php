      ...
      <nav class="navbar navbar-light bg-light navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          ...
          <ul class="nav justify-content-end">
            <li class="nav-item">
              <button type="button" class="btn btn-outline-primary"><a class="nav-link" href="doctor5.php">Home</a></button>
            </li>&nbsp;
...
<?php
            include("connection.php");
            error_reporting(0);
            $query = "SELECT * FROM prescription WHERE doctor = 'Dr. Gopal Krishna - Psychiatrist' GROUP BY date ASC ";
